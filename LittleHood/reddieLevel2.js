...
class reddieLevel2 extends Phaser.Scene {

    constructor ()
    {
        super({ key: 'reddieLevel2' });
        this.flowerCount = 0;
        this.lifeCount = 3;
        this.isDead = false;
    ...
    //this.bgmSound.stop();
    console.log('after collect say 10 flowers, jump to reddieLevel3');
    this.scene.stop("reddieLevel2");
