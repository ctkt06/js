...
class blueyLevel2 extends Phaser.Scene {

    constructor ()
    {
        super({ key: 'blueyLevel2' });
        this.flowerCount = 0;
        this.lifeCount = 3;
        this.isDead = false;
    ...
    //this.bgmSound.stop();
    console.log('after collect say 10 flowers, jump to blueLevel3');
    this.scene.stop("blueyLevel2");
    this.scene.start("blueLevel3");
}
    }
