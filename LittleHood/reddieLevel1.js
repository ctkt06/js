...
class reddieLevel1 extends Phaser.Scene {

    constructor ()
    {
        super({ key: 'reddieLevel1' });
        this.flowerCount = 0;
        //this.lifeCount = 3;
        //this.isDead = false;
    ...
    //this.bgmSound.stop();
    console.log('after collect say 10 flowers, jump to reddieLevel2');
    this.scene.stop("reddieLevel1");
