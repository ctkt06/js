...
class level3 extends Phaser.Scene {
    ...
    this.physics.add.overlap(this.player, this.flower,this.collectFlower, null, this );
        ...
        this.wolfie1.create(542, 4000, 'wolfie1').setScale(1.5);
        ...
        // Add members to wolfie group
        this.wolfie2.create(2135, 4000, 'wolfie2').setScale(1.5);
        this.wolfie2.create(2533, 2848, 'wolfie2').setScale(1.5);
        this.wolfie2.create(2533, 2848, 'wolfie2').setScale(1.5);
        this.wolfie2.create(400, 3424, 'wolfie2').setScale(1.5);
        this.wolfie2.create(398, 3424, 'wolfie2').setScale(1.5);
        ...
        this.wolfie2.create(3135, 1632, 'wolfie2').setScale(1.5);
    ...
    //this.bgmSound.stop();
    console.log('after collect say 10 flowers, jump to mainScene');
